...
module lab62_soc_mm_interconnect_0 (
	...
	wire          cmd_mux_013_src_valid;                                                              // cmd_mux_013:src_valid -> key_pio_s1_agent:cp_valid
	wire  [105:0] cmd_mux_013_src_data;                                                               // cmd_mux_013:src_data -> key_pio_s1_agent:cp_data
	wire          cmd_mux_013_src_ready;                                                              // key_pio_s1_agent:cp_ready -> cmd_mux_013:src_ready
	wire   [15:0] cmd_mux_013_src_channel;                                                            // cmd_mux_013:src_channel -> key_pio_s1_agent:cp_channel
	wire          cmd_mux_013_src_startofpacket;                                                      // cmd_mux_013:src_startofpacket -> key_pio_s1_agent:cp_startofpacket
	wire          cmd_mux_013_src_endofpacket;                                                        // cmd_mux_013:src_endofpacket -> key_pio_s1_agent:cp_endofpacket
	...
	wire  [105:0] cmd_mux_014_src_data;                                                               // cmd_mux_014:src_data -> timer_s1_agent:cp_data
	wire          cmd_mux_014_src_ready;                                                              // timer_s1_agent:cp_ready -> cmd_mux_014:src_ready
	wire   [15:0] cmd_mux_014_src_channel;                                                            // cmd_mux_014:src_channel -> timer_s1_agent:cp_channel
	...
	wire          key_pio_s1_agent_rp_valid;                                                          // key_pio_s1_agent:rp_valid -> router_015:sink_valid
	wire  [105:0] key_pio_s1_agent_rp_data;                                                           // key_pio_s1_agent:rp_data -> router_015:sink_data
	wire          key_pio_s1_agent_rp_ready;                                                          // router_015:sink_ready -> key_pio_s1_agent:rp_ready
	wire          key_pio_s1_agent_rp_startofpacket;                                                  // key_pio_s1_agent:rp_startofpacket -> router_015:sink_startofpacket
	wire          key_pio_s1_agent_rp_endofpacket;                                                    // key_pio_s1_agent:rp_endofpacket -> router_015:sink_endofpacket
	...
	wire  [105:0] timer_s1_agent_rp_data;                                                             // timer_s1_agent:rp_data -> router_016:sink_data
	...
	wire          key_pio_s1_agent_rdata_fifo_src_valid;                                              // key_pio_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_013:in_0_valid
	wire   [33:0] key_pio_s1_agent_rdata_fifo_src_data;                                               // key_pio_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_013:in_0_data
	wire          key_pio_s1_agent_rdata_fifo_src_ready;                                              // avalon_st_adapter_013:in_0_ready -> key_pio_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_013_out_0_valid;                                                  // avalon_st_adapter_013:out_0_valid -> key_pio_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_013_out_0_data;                                                   // avalon_st_adapter_013:out_0_data -> key_pio_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_013_out_0_ready;                                                  // key_pio_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_013:out_0_ready
	wire    [0:0] avalon_st_adapter_013_out_0_error;                                                  // avalon_st_adapter_013:out_0_error -> key_pio_s1_agent:rdata_fifo_sink_error
